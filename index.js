...
async function run() {
  try {
    ...
    app.post('/addIncomeData', async (req, res) => {
      ...
      res.send({ suc: true, insertedId: result.insertedId });
    });
...
app.delete("/rice-collections/:id", async (req, res) => {
  try {
    const id = req.params.id;
    const result = await riceCollection.deleteOne({ _id: new ObjectId(id) });
...
app.delete("/dokkhin-donations/:id", async (req, res) => {
  ...
  res.send(result);
    ...
    app.delete('/donations/:id', async (req, res) => {
      try {
        const id = req.params.id;
        const result = await majhaparaCollection.deleteOne({ _id: new ObjectId(id) });
